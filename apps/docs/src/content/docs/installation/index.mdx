...
<Callout type="info" title="Quick Start">
  If you're new to this library, we recommend starting with the [Introduction](/docs/introduction) page to understand our approach.
</Callout>
...
2. Copy component code directly into your project
3. Add Libs/utils
   ```tsx
