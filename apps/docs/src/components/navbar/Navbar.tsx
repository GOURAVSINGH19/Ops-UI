...
const Navbar = () => {
    ...
    return (
        <header className="w-full relative top-[.2rem] left-0 z-50 text-sm h-[var(--header-height)]">
            <nav className=" w-full p-[.5rem] gap-10 flex justify-between items-center border-b border-neutral-600/50">
                <div className="font-semibold md:block border-r border-neutral-600/50 w-[6rem] py-1">
                    <Link to="/">
                ...
                <div className="flex items-center gap-4 w-2/3 justify-end px-4">
                    ...
                    <ThemeToggle />
                    <Link to="/">
                        <button className=' flex justify-between cursor-pointer relative items-center p-2 dark:ring-[.5px] dark:ring-white/30 dark:hover:ring-white/10 hover:scale-[.98] flex justify-center items-center dark:bg-[var(--bg)] shadow-[var(--shadow-s)] rounded-md outline-0 text-sm gap-2 items-center flex duration-600 ease-inOut'>
                            <Github size={16} />
                        </button>
                    </Link>
                </div>
